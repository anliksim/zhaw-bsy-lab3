...
typedef struct mlist {
    unsigned int numNodes;              // number of list elements
...
mthread_t*   mlReadFirst(mlist_t* list);  // return ptr to first tcb in list, 
                                          // but do not dequeue

unsigned int mlGetNumNodes(mlist_t* list); // return number of elements in list
